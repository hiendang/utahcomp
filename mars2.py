...
params["eta"] = 0.015	# v1 0.015
params["min_child_weight"] = 5	# v1 5
...
rtrain_xgb,rtest_xgb = xgb_features(X,y,X_unknown,params=params,n_folds=5,early_stop=80,random_state=42)#random_state v1 42 v2 983
import cPickle
fi = open('xgb_res.pkl','wb')
